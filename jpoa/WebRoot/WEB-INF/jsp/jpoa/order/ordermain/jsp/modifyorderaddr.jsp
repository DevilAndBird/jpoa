...
<html>
  ...
  <body>
	...
	<input type='hidden' id ='orderAddrId' value='${pd.orderAddrId}'>
  	<input type='hidden' id ='addrType' value='${pd.addrType}'>
  	<input type='hidden' id ='orderid' value='${pd.orderid}'>
  	<input type='hidden' id ='addrTypeValue' value='${pd.addrTypeValue}'>
  	<input type='hidden' id ='addrType1' value='${pd.addrType1}'>
  </body>
  ...
  <script type="text/javascript" src="${ctx}/jpoa/order/ordermain/js/modifyorderaddr.js?r=<%=new Random().nextInt() %>"></script>
