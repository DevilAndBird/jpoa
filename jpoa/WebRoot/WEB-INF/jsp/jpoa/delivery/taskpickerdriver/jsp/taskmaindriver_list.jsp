		...
		<form action="taskmaindriver/findTaskMainDriverlistPage" method="post" name="Form" id="Form">
			<table>
				<tr>
					...
					<td style="vertical-align:top;"> 
					 	<select name="driverid" id="seleDriverid" data-placeholder="省份" style="vertical-align:top;width: 120px;">
							<option value="-1" selected="selected">--取件员--</option>
							<c:forEach items="${driverList}" var="obj" varStatus="vs">
								<option value="${obj.id}" <c:if test="${obj.id==pd.driverid}">selected</c:if>>${obj.name}</option>
							</c:forEach>
					  	</select>
					</td>
					<td style="vertical-align:top;"> 
...
<!-- 模态框（Modal） -->
             ...
             <div class="modal-content" >
                 ...
                 <div class="modal-body">
					<div id ="divTask">
						...
						<div class="row-fluid">
							<select id="seleDriverid_modal" data-placeholder="取件员" style="vertical-align:top;width: 120px;">
								<option value="-1" selected="selected">--取件员--</option>
								<c:forEach items="${driverList}" var="obj" varStatus="vs">
						...
						<div class="row-fluid">
							<input type="text" id="srcaddr_model" placeholder="发车地址"/>
							<input type="text" id="destaddr_model" placeholder="目的地址"/>
						</div>
						<div class="row-fluid">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		<script type="text/javascript" src="${ctx}/jpoa/delivery/taskpickerdriver/js/taskmaindriver_list.js?r=<%=new Random().nextInt()%>"></script>
		
		<script type="text/javascript">
			$(function() {
				taskPickerDriver_list.init();
			});
		</script>
		<script type="text/javascript">
			$(function() {
