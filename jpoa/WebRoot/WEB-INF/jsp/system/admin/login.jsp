...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" id="loginname" value="" placeholder="请输入用户名" style = "background-color: transparent; border: 0;color:white;"/>
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							placeholder="请输入密码" class="keypad" keypadMode="full" allowKeyboard="true" value="" style = "background-color: transparent; border: 0;color:white;"/> 
						</div>
					</div>
				</div>
					...
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;" class="codediv">
							<input type="text" name="code" id="code" class="login_code"
								style="height:16px; padding-top:4px;background-color: transparent; border: 0;color:white;" placeholder="验证码"/>
						</div>
						<div style="float: left;">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 上海景沛网络</span></font>
				</div>
			</div>
		</div>
		</div>
