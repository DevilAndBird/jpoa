 ...
 *
 * 类描述：分配不同区域规则
 * 类名称：com.fh.rule.autoallot.AllotDiffAreaRule     
 * 创建人：tangqm
 * 创建时间：2018年9月26日 下午9:00:54   
 * 修改人：
 * 修改时间：2018年9月26日 下午9:00:54   
 * 修改备注：
 */
@Component
public class AllotDiffAreaRule implements BaseRule{
	...
	public void execute(AutoAllotParam autoAllotParam) throws RuleException {
		...
		for (int i=0;i<haulWayList.size();i++) {
				HaulWayDetail haulWayDetail = haulWayList.get(i);
				if(StringUtils.isEmpty(haulWayDetail.getSrcid())){//分配出发地
