...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctx}/jpoa/order/ordermain/css/waitallotedit.css?r=<%=new Random().nextInt() %>" />
	</head>  
	...
	<body class='bodywaitallotedit'>
	    ...
	    <div id ='divbutton'>
	        <img class='imgorderallotpath' title='单击：查看订单分配路径' onclick='orderallotpath()'>
		...
		<script type="text/javascript" src="${ctx}/jpoa/order/ordermain/js/waitallotedit.js?r=<%=new Random().nextInt() %>"></script>
	</body>
</html>