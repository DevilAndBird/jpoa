...
<html>
	...
	<body>
		<div id="addTool">
			<table>
				<tr >
					<td>
						&nbsp;&nbsp;
						<button class="btn btn-mini btn-light" onclick="editRegionCityPoint()" title="保存所画区域" data-toggle="modal" data-target="#myModal">
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
         <div class="modal-dialog">
             ...
             <div class="modal-footer">
                 ...
                 <button id="btnEditRegionCityGps" type="button" class="btn btn-primary">修改</button>
             </div>
         </div>
         </div>
		...
		<script type="text/javascript" src="${ctx}/jpoa/delivery/baiduMap/regioncity/js/editregioncity.js?r=<%=new Random().nextInt() %>"></script>
		
		
		<script type="text/javascript"> 
	     	 $(function(){
	     		editregioncityMapInit();
	     	 });
		</script>
	</body>  
</html>