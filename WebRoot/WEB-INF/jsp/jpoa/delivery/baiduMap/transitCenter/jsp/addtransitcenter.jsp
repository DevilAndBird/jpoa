...
<html>
	...
	<body>
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 <div class="modal-header">
                     ...
                     <h4 id="h4DeliveryMan" class="modal-title">新增集散中心区域划分</h4>
                 </div>
                 <div class="modal-body">
	                  <div class="row-fluid">
						...
						<div>
							   <input autocomplete="off" type="text" name="timespan" id="timespan"  placeholder="请输入时间间隔" style="width:120px" />
						</div>
						<div>
             ...
             <div class="modal-footer">
                 ...
                 <button id="btnSaveTransitCenterGps" type="button" class="btn btn-primary">编辑</button>
             </div>
         </div>
         </div>
		...
		<script type="text/javascript" src="${ctx}/jpoa/delivery/baiduMap/transitCenter/js/addtransitcenter.js?r=<%=new Random().nextInt() %>"></script>
		
		
		<script type="text/javascript"> 
	     	 $(function(){
	     		addtransitcenterInit();
	     	 });
		</script>
	</body>  
</html>