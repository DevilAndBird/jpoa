...
<body>
	<form action="<%=basePath%>wfs/save.do" name="userForm" id="userForm" method="post">
		<div id="zhongxin">
		<table>
		    <tr>
			...
			<tr>
				<td>			   
				      <select  name="flowname">
				           ...
				           <option value="${wfi.flowname}+${wfi.id}">${wfi.flowname}</option>
				           </c:forEach>
				</select>
				</td>
			</tr>
			<tr>
				...
				<select  name="sheetname">
				           ...
				           <option value="${si.sheetname}+${si.id}">${si.sheetname}</option>
				           </c:forEach>
				</select>
				</td>
			</tr>
