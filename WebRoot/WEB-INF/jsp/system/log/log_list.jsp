...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="log01/show1.do" method="post" name="userForm" id="userForm">
			<table>
				<tr>
					<td>
								...
								<td style="width: 60px;">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<c:if test="${QX.FW_QX == 1 }">
												 ...
												 <a class='btn btn-mini btn-danger' href="<%=request.getContextPath()%>/notice01/show4?id=${user.id}">删除<i class='icon-trash'></i></a>
									</div>
								</td>
							</tr>
		...
		<table style="width:100%;">
			<tr>
				<td style="vertical-align:top;">
					<c:if test="${QX.add == 1 }">
					<a class="btn btn-small btn-success" href="${pageContext.request.contextPath}/notice01/show5.do">新增</a>
					</c:if>
				</td>
