...
public class UserService {
	...
	*/
	public boolean getSelectBoolean(Integer postid) throws Exception {
		List<User>list  =(List<User>) dao.findForList("UserMapper.getboolean", postid);
		if(list.size()>0){
			return true;
		}else{
			return false; 			
	...
	*得到用户名字
	*/
	public List<User> getUsername(Integer postid) throws Exception {
		return (List<User>)dao.findForList("UserXMapper.getboolean", postid);
